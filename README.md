# Pre-screening along with Identification of Potential Hotspot Region for COVID-19
...
# Identification of Hotspot Region
Pre-screened results along with the user location will be utilised to identify hotspot regions. Heatmap of the regions can be generated. If a region has a substantial number of suspicious population, the region will be marked for hotspot along with the severity. The idea behind providing a heatmap is helpful for taking proactive action in the region. The user can also be prompted to retest after a defined SLA (7 days) to keep updated track with the help of notifications. 
